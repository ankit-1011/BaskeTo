...
const InputField = ({ type, placeholder, handleChange, name, address, }) => {
    return (<input className='w-full px-2 py-2.5 border border-gray-500/30 rounded outline outline-none text-gray-500 focus:border-primary transition' type={type} placeholder={placeholder} onChange={handleChange} namae={name} value={address[name]} required />)
}
            ...
            <div className='flex flex-col-reverse md:flex-row justify-between mt-10'>
                <div className='flex-1 max-w-md'>
                    <form onSubmit={onSubmitHandler} className='space-y-3 mt-6 text-sm'>
                        ...
                        <InputField type="text" name="emial" placeholder="Email" onChange={handleChange} address={address} />
