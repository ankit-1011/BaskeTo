    ...
    return !isseller && (
        <form onSubmit={onSubmitHandler} className='min-h-screen flex items-center text-sm text-gray-600'>
            ...
            <div className='flex flex-col gap-5 m-auto items-start p-8 py-12 min-w-80 sm:min-w-88 rounded-1g shadow-xl border border-gray-200'> <p className='text-2x1 font-medium m-auto'><span className="text-primary">Seller</ span> Login</p>
                ...
                <div className="w-full">
                    <p>Password</p>
                    <input onChange={(e)=>setPassword(e.target.value)}  value={password} type="password" placeholder="enter your password" className="border border-gray-200 rounded w-full p-2 mt-1 outline-primary" I required />
                </div>
